    ...
    if (impersonating) {
        return <>
            <Card className={'w-80 text-center m-auto'}>
                ...
                <Card.Footer>
                    {impersonateFailure &&
                        <div><font color="red">Person you are trying to impersonate does not exist or have that
                            role</font></div>}
                </Card.Footer>
            </Card>
        </>
            ...
            <Card className={'w-80 text-center m-auto'}>
                ...
                <Form className={'p-3'} onSubmit={onEditSubmit} style={{backgroundColor: 'lightcyan'}}>
                    <Form.Group className={'mb-3'}>
                        ...
                        <input onChange={updateUsername} value={editState.username}
                               placeholder={selectedUser[0].username} type='text'/>
                    </Form.Group>
                    <Form.Group className={'mb-3'}>
                        <Form.Label>Password:</Form.Label>
                        <input onChange={updatePassword} value={editState.password}
                               placeholder={selectedUser[0].password} type='text'/>
                    </Form.Group>
